    ...
    <main className="mx-auto max-w-[1600px] px-12 max-md:px-4 pt-8 pb-16">
      <header className="mb-7 flex items-start justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          {/* Weekly Goals — fast weekly-priority planner + performance
              dashboard. Lives alongside the Tasks views. */}
          <Link
            href={"/tasks/weekly-goals" as Route}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-[14.5px] font-bold text-ink-strong border border-hairline bg-surface-card transition-all hover:brightness-95 active:scale-[0.98]"
          >
